        ...
        return (
            <div className="main">
                ...
                {this.state.RenderedHorne.map((item, index) => {
                    return (
                        <HornedBeasts renderModal={this.props.renderModal} selectedBeast={item.title} title={item.title} prag={item.description} url={item.image_url} keyValue={index} key={index} />
                    );
                })}
