...
class Main extends React.Component {
    render() {
        ...
        let likeIncreas = (likesNumber) => {
            return likesNumber++;
        };
        
        return (
            <div>
                <HornedBeastList likeNumber={0} />
                <HornedBeasts title={HornedBeastList[0].title} image_url={HornedBeastList[0].image_url} likes={likes} raisLikes={likeIncreas} description={HornedBeastList[0].description} />
