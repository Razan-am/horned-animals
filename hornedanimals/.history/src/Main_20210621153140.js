    ...
    render() {
        ...
        return (
            <div>
                ...
                <HornedBeasts title={HornedBeastList[2].title} image_url={HornedBeastList[1].image_url} description={HornedBeastList[2].description}/>
                <HornedBeasts title={HornedBeastList[2].title} image_url={HornedBeastList[1].image_url} description={HornedBeastList[3].description}/>
                <HornedBeasts title={HornedBeastList[3].title} image_url={HornedBeastList[1].image_url} description={HornedBeastList[3].description}/>
                <HornedBeasts title={HornedBeastList[4].title} image_url={HornedBeastList[1].image_url} description={HornedBeastList[1].description}/>
                <HornedBeasts title={HornedBeastList[1].title} image_url={HornedBeastList[1].image_url} description={HornedBeastList[1].description}/>
            </div>
        );
    }
