        ...
        return (
            <div>
                ...
                <HornedBeasts
                    ...
                    title={for (let index = 0; index < HornedBeastList.length; index++) {{HornedBeastList[index].title}} image_url={HornedBeastList[index].image_url} description={HornedBeastList[index].description   
                }/>
            </div>
        );
    }
