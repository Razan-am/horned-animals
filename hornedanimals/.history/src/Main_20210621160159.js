    ...
    render() {
        ...
        return (
            <div>
                ...
                <HornedBeasts title={HornedBeastList[19].title} image_url={HornedBeastList[10].image_url} description={HornedBeastList[19].description} />
                <HornedBeasts title={HornedBeastList[20].title} image_url={HornedBeastList[20].image_url} description={HornedBeastList[20].description} />
