...
class Main extends React.Component {
    render() {
        ...
        return (
            <div>
                <HornedBeasts title={HornedBeastList[0].title} image_url={HornedBeastList[0].image_url} likes={likes} likesNumber={likeNumber} raisLikes={likeIncreas} description={HornedBeastList[0].description} />
